...
setup(
    ...
    author_email='tuncturker.work@gmail.com',   # Author's email
    description=(
    ...
    long_description_content_type=(
        'text/markdown',  # Format of long description
    ),
    url=(
        'https://github.com/Turkero/ACE_Lensing',  # URL to the package repo
    ),
    ...
    install_requires=[                  # Dependencies
        ...
        'pandas>=2.2.3',                    # For data manipulation & analysis
        'pyarrow>=5.0.0',                   # For reading .parquet files
